...
import { participants } from "@/tests/mock";
    ...
    const applyFilters = (
        ...
        const filteredParticipants = participantsToFilter.filter(
            (participant) =>
                ...
                ((participantFilter && participant.type === "Participant") ||
                    (volunteerFilter && participant.type === "Volunteer") ||
                    (participantFilter && volunteerFilter))
        );
            ...
            {showFilterBar && (
                <div className={styles.filterbar}>
                    <div className={styles.parent}>
                        <input
                            className={styles.filterbar_search}
                            type="search"
                    ...
                    <div className={styles.parent_bottom}>
                        ...
                        ></input>{" "}
                        <p className={styles.checkbox}>Participants</p>
                        <input
                            className={styles.box}
                            type="checkbox"
                            checked={volunteerFilter}
                            onChange={() =>
                                setVolunteerFilter(!volunteerFilter)
                            }
                        ></input>{" "}
                        <p className={styles.checkbox}>Volunteer</p>
                        <div className={styles.button}>
                            <button
                                className={styles.apply}
                                onClick={() => applyFilters(participants)}
                            >
                                APPLY
                            </button>
                        </div>
